...
- [src/bsdoc.langium](src/bsdoc.langium) -  The grammar definition of your language
- [src/bsdoc-module.ts](src/bsdoc-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/bsdoc-validator.ts](src/bsdoc-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [syntaxes/bsdoc.tmLanguage.json](syntaxes/bsdoc.tmLanguage.json) - Textmate based syntax highlighting instructions.
