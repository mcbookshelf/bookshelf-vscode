...
- [src/bookshelf-doc.langium](src/bookshelf-doc.langium) -  The grammar definition of your language
- [src/bookshelf-doc-module.ts](src/bookshelf-doc-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/bookshelf-doc-validator.ts](src/bookshelf-doc-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [syntaxes/bookshelf-doc.tmLanguage.json](syntaxes/bookshelf-doc.tmLanguage.json) - Textmate based syntax highlighting instructions.
